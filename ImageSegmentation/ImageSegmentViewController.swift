...
class ImageSegmentViewController: UIViewController {
    ...
    // MARK: - Miscellaneous Preoperties
...
extension ImageSegmentViewController: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
...
extension ImageSegmentViewController {
...
// MARK: - Scroll View Delegate(for Zooming)
extension ImageSegmentViewController: UIScrollViewDelegate {
...
extension ImageSegmentViewController: UITableViewDataSource {
